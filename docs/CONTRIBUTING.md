...
The toolkit relies on a local LLM running via Ollama.
...
2. Pull the required model:
   ...
   _(Note: The project defaults to `qwen3:8b`. If you use a different model, ensure your hardware can handle it and verify compatibility.)_
