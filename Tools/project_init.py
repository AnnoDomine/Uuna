...
def init_settings():
    ...
    # Default settings
    default_settings = [
        ('workers', '4', 'Parallel Workers', 'Number of simultaneous table downloads and imports.', 'Performance', 'int'),
        ('sync_builds_list_on_startup', '1', 'Update Registry on Startup', 'Automatically fetch the latest build list from Wago.tools when the GUI starts.', 'Startup', 'bool'),
        ('map_references_use_global_mapping', '0', 'Use Global Column Mapping', 'Enable sharing learned column-to-table relationships across all builds.', 'Mapping', 'bool'),
        ('map_references_auto_skip_unidentifiable', '0', 'Auto-skip Unidentifiable Refs', 'Automatically skip ambiguous columns instead of asking during mapping sessions.', 'Mapping', 'bool'),
