...
def resolve_table_name(
    potential_name, tables, user_mappings, global_mappings, mapping_path, current_table, current_col, use_global=True
):
    ...
    if headless_mode:
        if mapping_key not in pending_mappings:
            pending_mappings[mapping_key] = {"base": potential_name, "suggestions": suggestions[:5]}
        return None
