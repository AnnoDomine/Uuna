...
WOW_CLASSES_SPECS = [
    ...
    {"class": "Monk", "specs": ["Brewmaster", "Mistweaver", "Windwalker"], "role": "Tank / Healer / Melee DPS"},
    {
        ...
        "role": "Ranged / Melee DPS / Tank / Healer",
    },
    {
        "class": "Demon Hunter",
        "specs": ["Havoc", "Vengeance", "Void-Stalker (Midnight)"],
        "role": "Melee DPS / Tank / Ranged-Support (TBD)",
    },
    {
        "class": "Evoker",
        "specs": ["Augmentation", "Devastation", "Preservation"],
        "role": "Support / Ranged DPS / Healer",
    },
]
...
WOW_BRANCH_TYPES = [
    ...
    {
        "branch": "Classic Progression",
        "product": "wow_classic",
        "context": "Classic expansions (currently evolving through Cata/MoP).",
    },
...
LORE_BASICS = [
    {
        "entity": "Arthas Menethil",
        "context": "The Lich King, former Prince of Lordaeron. Central to WotLK (3.x) and Shadowlands (9.x).",
    },
    {
        "entity": "Jaina Proudmoore",
        "context": "Powerful mage, leader of Kul Tiras. Key figure in BfA (8.x) and many other expansions.",
    },
    {
        "entity": "Sylvanas Windrunner",
        "context": "Former Warchief, Banshee Queen. Main antagonist in Shadowlands (9.x).",
    },
    ...
    {
        "entity": "Anduin Wrynn",
        "context": "King of Stormwind, son of Varian Wrynn. Key in MoP (5.x), Legion, BfA, and TWW.",
    },
    {
        "entity": "The Burning Legion",
        "context": "Demon army led by Sargeras. Main threat in TBC (2.x) and Legion (7.x).",
    },
    {
        "entity": "The Void / Old Gods",
        "context": "Cosmic force, enemies of the Titans. Key figures: C'Thun, Yogg-Saron, N'Zoth (BfA).",
    },
]
...
WOW_COSMOLOGY = [
    {
        "force": "Order",
        "entity": "Titans / Pantheon",
        "context": "Shapers of worlds, creators of the Dragon Aspects. Key figures: Aman'Thul, Sargeras (fallen), Eonar.",
    },
    {
        "force": "Disorder",
        "entity": "Burning Legion",
        "context": "Demonic army seeking to undo creation. Led by the fallen Titan Sargeras.",
    },
    {
        "force": "Life",
        "entity": "The Wild Gods / Emerald Dream",
        "context": "Representation of nature and growth. Key figures: Elune, Cenarius.",
    },
    {
        "force": "Death",
        "entity": "Shadowlands / Eternal Ones",
        "context": "The afterlife. Divided into realms like Bastion, Maldraxxus, Ardenweald, and Revendreth. Key: The Jailer, The Arbiter.",
    },
    {"force": "Light", "entity": "Naaru / Holy Light", "context": "Force of healing and crystalline entities."},
    {
        "force": "Shadow",
        "entity": "Void Lords / Old Gods",
        "context": "Corruptive force seeking to consume the universe.",
    },
]
...
WOW_GEOGRAPHY = [
    {
        ...
        "context": "Home of Humans, Dwarves, Gnomes, Forsaken, and Blood Elves. Key cities: Stormwind, Ironforge, Silvermoon.",
    },
    {
        "continent": "Kalimdor",
        "context": "Home of Orcs, Trolls, Tauren, and Night Elves. Key cities: Orgrimmar, Thunder Bluff.",
    },
...
WOW_CITIES = [
    ...
    {"city": "Orgrimmar", "continent": "Kalimdor", "context": "Orc capital, Horde hub."},
    {
        ...
        "context": "Blood Elf capital. Central hub for Midnight (12.x).",
    },
    {
        "city": "Dalaran",
        "continent": "Floating",
        "context": "Mage city, moved multiple times (Northrend, Broken Isles).",
    },
...
WOW_HISTORY = [
    {
        "event": "The War of the Ancients",
        "context": "First invasion of the Burning Legion, leading to the Sundering of Azeroth (10,000 years ago).",
    },
    {
        "event": "The Great Sundering",
        "context": "The explosion of the Well of Eternity, splitting the world into continents.",
    },
    {
        "event": "The Rise of the Horde",
        "context": "Corruption of the Orcs on Draenor and the opening of the Dark Portal.",
    },
    ...
    {
        "event": "The Worldsoul Saga",
        "context": "Trilogy starting with TWW (11.x), Midnight (12.x), and The Last Titan (13.x).",
    },
]
...
CORPORATE_CONTEXT = [
    {"entity": "Blizzard Entertainment", "context": "Developer of World of Warcraft. Founded 1991."},
    {
        ...
        "context": "Parent company formed by the merger of Activision and Vivendi Games (Blizzard's parent) in 2008.",
    },
    {
        "entity": "Microsoft",
        "context": "Acquired Activision Blizzard in 2023. WoW is now part of the Xbox/Microsoft ecosystem.",
    },
    {
        "entity": "Metzen",
        "context": "Chris Metzen, the 'father' of Warcraft lore, returned as Executive Creative Director for the Worldsoul Saga.",
    },
]
